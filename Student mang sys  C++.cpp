	...
	protected:
		...
		public:
			void input_details()
			{
				...
				cin>>sub3;
				cout<<"\n";
				cout<<"\n\nEnter the Mark of Environment Science ==>";
				cin>>sub4;
				cout<<"\n";
				cout<<"\n\nEnter the Mark of ART ==>";
				cin>>sub5;
				cout<<"\n";
			...
			void output_details()
			{
				cout<<"\tIUBAT - International University of Business Agriculture and Technology"<<endl;
			...
			void output_marksheet()
			{
				...
				cout<<"Marks of Environment Science	         100                       "<<sub4<<endl;
				cout<<"Marks of ART 		    	 	 100                          "<<sub5<<endl;
		...
		void update()
		{
			...
			switch(choice)
			{
				...
				case 12:
					...
					break;
				case 13:
					cout<<"\n\n Enter Marks of Environment Science :--->";
					cin>>sub4;
					cout<<"\n";
					break;
				case 14:
